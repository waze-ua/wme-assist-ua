...
function run_wme_assist() {
    ...
    var Rules = function (countryName) {
        ...
        var rules_RU = function () {
            ...
            var exAdjW = 'Репищева|Зеленина|Карташихина|Опочинина|Остоумова|Гаврикова|Прасковьина|Козлова|Усачёва|Бармалеева|Гусева|Ильмянинова|Комарова|Крюкова|Миронова|Остоумова|Панфилова|Перфильева|Плуталова|Подрезова|Полозова|Рашетова|Сегалева|Старцева|Тарасова|Шамшева|Шарова|Эсперова|Замшина|Куракина|Ольгина|Опочинина|Осокина|Рюхина|Тосина|Веткина|Ильина|Яковлева|Мишина';
