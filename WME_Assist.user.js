        ...
        var rules_RU = function () {
            return rules_basicRU().concat([
                ...
                new Rule('Incorrect street name', function (text) {
                    ...
                    var exStatus = '[А-Я][0-9]|[0-9]+$|метро|ворота|разворот|шлагбаум|трамвай|пути|Мост|подход|подъезд|обход|Объездная|въезд|выезд|слобода|городок|посёлок|Грейдер|^на |^в |^к |^под |^с |^от |ж\\/д|КАД|[0-9][0-9][А-Я]:\\/|[0-9][0-9]:|^$|[А-Я]\\-[0-9]|[0-9]+$| - ';
