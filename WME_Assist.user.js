    ...
    var Rules = function (countryName) {
        ...
        var rules_RU = function () {
            return rules_basicRU().concat([
                new Rule('Incorrect street name', function (text) {
                    var text0 = text;
                    if (/Нехая|Тукая|Мая|Барклая|Батырая|Маклая|Бикбая|Амантая|Нечая|Эшпая|Орая|Прикамья/.test(text)) return text;
                ...
                new Rule('Incorrect street name', function (text) {
                    var text0 = text;
                    if (/Расковой|Дуровой|Космодемьянской|строй|Ковалевской|Борисовой|Давлетшиной|Крупской|Шевцовой|Чайкиной|Богомоловой|Савиной/.test(text)) return text;
