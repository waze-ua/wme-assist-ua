        ...
        var rules_UA = function () {
            ...
            return rules_basicCommon().concat([
                ...
                new Rule('Detect status absense or incorrect placement', function (t) {
                    return hasStatus(t) ? (hasAdjName(t) ? t.replace(/(.*)(вул\.)(.*)/, '$1 $3 $2') : t) : '';
                }, 'Lviv'),
